...
open class MarkerViewChart: NSUIView, MarkerChart
{
    ...
    @objc
    open class func viewFromXib(in bundle: Bundle = .main) -> MarkerViewChart?
    {
        #if !os(OSX)
        ...
        return bundle.loadNibNamed(
            ...
            owner: nil,
            options: nil)?[0] as? MarkerViewChart
        #else
        ...
        {
            return loadedObjects?[0] as? MarkerViewChart
        }
