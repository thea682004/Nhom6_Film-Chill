...
@objc(ChartHighlight)
open class HighlightChart: NSObject
{
    ...
    private var _axis: YAxisChart.AxisDependency = YAxisChart.AxisDependency.left
    ...
    @objc open var axis: YAxisChart.AxisDependency { return _axis }
...
extension HighlightChart {
    open override func isEqual(_ object: Any?) -> Bool {
        guard let object = object as? HighlightChart else { return false }
