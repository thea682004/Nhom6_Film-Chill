...
open class XAxisRenderHorizontalBarChart: XAxisRenderBarChart
{
    internal weak var chart: BarChartView?
    
    @objc public init(viewPortHandler: ViewPortHandler, axis: XAxisChart, transformer: TransformerBarChart?, chart: BarChartView)
    {
    ...
    open override func computeAxis(min: Double, max: Double, inverted: Bool)
    {
        ...
        {
            let p1 = transformer.valueForTouchPointBarChart(CGPoint(x: viewPortHandler.contentLeft, y: viewPortHandler.contentBottom))
            let p2 = transformer.valueForTouchPointBarChart(CGPoint(x: viewPortHandler.contentLeft, y: viewPortHandler.contentTop))
    ...
    open override func drawLabels(context: CGContext, pos: CGFloat, anchor: CGPoint)
    {
        ...
        for i in 0..<axis.entryCount
        {
            ...
            transformer.pointValueToPixelBarChart(&position)
