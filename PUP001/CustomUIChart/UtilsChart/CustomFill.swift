...
@objc(ChartEmptyFill)
public class EmptyFill: NSObject, CustomFill
{
...
@objc(ChartColorFill)
public class ColorFill: NSObject, CustomFill
{
...
@objc(ChartImageFill)
public class ImageFill: NSObject, CustomFill
{
...
@objc(ChartLayerFill)
public class LayerFill: NSObject, CustomFill
{
...
public class LinearGradientFill: NSObject, CustomFill
{
...
public class RadialGradientFill: NSObject, CustomFill
{
